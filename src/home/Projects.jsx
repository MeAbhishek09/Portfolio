...
function Projects() {
  ...
  return (
    <div id="projects" className="  text-white flex flex-col items-center py-10 bg-gray-100 ">
      <motion.h1
        className=" pb-5 mb-5 font-extrabold bg-gradient-to-r from-sky-400 to-indigo-500 bg-clip-text text-transparent text-3xl md:text-3xl lg:text-4xl"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl w-full px-6 sm:text-2xl md:text-3xl ">
