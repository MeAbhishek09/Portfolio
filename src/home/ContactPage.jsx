...
function ContactPage() {
  return (
    <section
      id="contact"
      className="bg-gray-900 text-white flex flex-col md:flex-row relative h-auto md:h-screen w-full overflow-hidden"
    >
      <StarsBackground />

      {/* Left Side - Mailbox Animation */}
      <div className="w-full md:w-1/2 flex items-center justify-center relative py-10 md:py-0">
