...
export default function Timeline() {
  ...
  return (
    <section className="w-full min-h-screen bg-gradient-to-b from-gray-900 to-black text-white py-12 px-6 flex flex-col items-center">
      <h2 className="text-4xl font-bold mb-10">My Academic Journey</h2>
        ...
        <div className="space-y-16">
          {activities.map((item, index) => (
            ...
            >
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-red-600 shadow-lg text-xl">
                {item.icon}
              </div>
