...
export default function AcademicsTimeline() {
  ...
  return (
    <section className="w-full  bg-gradient-to-r from-blue-500 to-purple-600 text-white py-12 px-0 sm:px-8 lg:px-12 flex flex-col items-center">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-10 text-center px-4 sm:px-6 lg:px-8">
        My Academic Journey
      </h2>
